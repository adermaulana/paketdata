...
(function ($) {
  ...
  var $dropdown_legacy_offset_container = $(
    "<div />",
    { class: "mb-1" }
  )
  ...
  var $sidebar_collapsed_container = $(
    "<div />",
    { class: "mb-1" }
  )
  ...
  $(document).on(
    ...
    function () {
      $sidebar_collapsed_checkbox.prop(
        "checked",
        true
      );
    }
  ...
  var $child_indent_sidebar_container = $(
    "<div />",
    { class: "mb-1" }
  )
  ...
  $container.append(
    $child_indent_sidebar_container
  );
  ...
  var $no_expand_sidebar_container = $(
    "<div />",
    { class: "mb-4" }
  )
  ...
  var navbar_all_colors =
    navbar_dark_skins.concat(navbar_light_skins);
  ...
  $(".main-header")[0].classList.forEach(
    function (className) {
      if (
        navbar_all_colors.indexOf(className) >
          -1 &&
        active_navbar_color === null
      ) {
        active_navbar_color = className.replace(
          "navbar-",
          "bg-"
        );
      }
  ...
  $container.append(
    createSkinBlock(
      ...
      function () {
        ...
        var accent_color_class = color.replace(
          "bg-",
          "accent-"
        );
  ...
  $("body")[0].classList.forEach(function (
    className
  ) {
    if (
      ...
      active_accent_color = className.replace(
        "navbar-",
        "bg-"
      );
    }
  ...
  $(".main-sidebar")[0].classList.forEach(
    function (className) {
      var color = className.replace(
        "sidebar-dark-",
        "bg-"
      );
      if (
  ...
  if (active_sidebar_light_color !== null) {
    $sidebar_light_variants
      .find(
        "option." + active_sidebar_light_color
      )
      .prop("selected", true);
    $sidebar_light_variants
      .removeClass()
  ...
  $(".brand-link")[0].classList.forEach(function (
    className
  ) {
    if (
      ...
      active_brand_color = className.replace(
        "navbar-",
        "bg-"
      );
    }
